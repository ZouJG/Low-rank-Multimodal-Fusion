...
class RequestApi(object):
    ...
    def all_api_request(self):
        ...
        while True:
            ...
            time.sleep(20)
        # 5 . 获取结果
        r = self.get_result_request(taskid=taskid)
        r = eval(r['data'])
        return r
...
if __name__ == '__main__':
    APP_ID = "5f485e78"
    SECRET_KEY = "bd3711b8a111dc48523b7409d69fafa0"
    video_dir = r'E:\抑郁症项目\音频'
    text_dir = r'E:\抑郁症项目\文本'
    ...
    for video in os.listdir(video_dir):
        ...
        # file_path = r"E:\抑郁症项目\video_demo-master\陈桂青.wav"
        api = RequestApi(appid=APP_ID, secret_key=SECRET_KEY, upload_file_path=file_path)
        r = api.all_api_request()
        # r = api.get_result_request(taskid='184c20253dba4fd38bd2727e7b8a3525')
        out_file = os.path.join(text_dir,ID) + '_text.txt'
        with open(out_file, 'w') as f:
            for i in r:
                f.write(i['speaker'] + ':' + i['onebest'] + '\n')
